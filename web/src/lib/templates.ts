/**
 * Kryct Template Hub — 12 beginner-friendly starter sandboxes.
 *
...
`,
  ...
  },
  {
    ...
    files: {
      ...
      "index.html": NEON_PAGE(
        "Markdown Engine",
        `<h1>📝 Markdown <span class="glow">Engine</span></h1>\n<div class="split"><textarea id="src"># Hello Kryct\n\nType **markdown** and watch it _render_ live.\n\n- bullet one\n- bullet two</textarea><div id="out" class="card"></div></div>\n<script src="md.js"></script>`,
      ),
      "md.js": `// Escape HTML first so typed markup can't inject scripts, THEN apply the
// markdown formatting. (Never set innerHTML from raw user input.)
function esc(s) {
