 ...
 *
 * Header actions:
 *   📥 Download .zip → bundles every workspace text file into neondeck-project.zip
 *   🚀 Deploy to Web → opens the subscription paywall (cloud hosting is paid)
 */
export function FileDrawer() {
  ...
  async function downloadZip() {
    ...
    try {
      ...
      downloadBlob(blob, "neondeck-project.zip");
    } catch (err) {
    ...
    <aside className="ws-tree">
      ...
      <div className="ws-tree-actions">
        ...
        <button
          ...
          title="Deploy this project to the NeonDeck cloud"
        >
          🚀 Deploy to Web
        </button>
      </div>
